...
test("service worker caches OAuth navigations only under the canonical shell URL", () => {
  ...
  assert.match(worker, /what-i-made-capture-v54/);
  assert.match(worker, /\.\/conversational-cleanup\.js\?v=2/);
  assert.match(worker, /\.\/capture-parser\.js\?v=18/);
  assert.match(worker, /\.\/capture-assistance\.js\?v=29/);
  ...
  assert.match(html, /\.\/conversational-cleanup\.js\?v=2/);
  assert.match(html, /\.\/capture-parser\.js\?v=18/);
  assert.match(html, /\.\/capture-assistance\.js\?v=29/);
