...
- Production Cognito redirects, API Gateway pre-Lambda rejection, the actual owner-device migration prompt, old Function URL removal, and installed-iPhone suspend/resume and VoiceOver remain deployment evidence gaps.
